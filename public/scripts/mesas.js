  ...
  try {
    ...
    if (button3.style.backgroundColor === "green") {
      Swal.fire({
        ...
        html: `
          <form id="agregarUsuarioForm" method="post" action="/user/WaiterVentas1">
            <input type="hidden" name="estadoBoton" value="4">
            <div id="platos-container" class="form-group" >
              <!-- Los campos de los platos se generarán aquí -->
            </div>
            <br/>
  ...
  try {
    ...
    if (button4.style.backgroundColor === "green") {
      Swal.fire({
        ...
        html: `
          <form id="agregarUsuarioForm" method="post" action="/user/WaiterVentas1">
            <input type="hidden" name="estadoBoton" value="6">
            <div id="platos-container" class="form-group" >
              <!-- Los campos de los platos se generarán aquí -->
            </div>
            <br/>
      ...
      document
        ...
        .addEventListener("submit", async (event) => {
          try {
            ...
            const form = event.target;
            const formData = new FormData(form);
            const respondse = await axios.post("/user/WaiterVentas1", {
              estadoBoton: "6",
              platillo: Array.from(formData.getAll("platillo")),
              cantidades: Array.from(formData.getAll("cantidades")),
              precios: Array.from(formData.getAll("precios")),
...
async function presiono5() {
  try {
    ...
    const platos = plato1.data;
    console.log(platos);
    if (button5.style.backgroundColor === "green") {
      Swal.fire({
        title: "Registrar Venta",
        showCancelButton: false,
        showConfirmButton: false,
        html: `
          <form id="agregarUsuarioForm" method="post" action="/user/WaiterVentas1">
            <input type="hidden" name="estadoBoton" value="8">
            <div id="platos-container" class="form-group" >
              <!-- Los campos de los platos se generarán aquí -->
            </div>
            <br/>
...
async function presiono6() {
  try {
    ...
    const platos = plato1.data;
    console.log(platos);
    if (button6.style.backgroundColor === "green") {
      Swal.fire({
        title: "Registrar Venta",
        showCancelButton: false,
        showConfirmButton: false,
...
async function presiono7() {
  try {
    ...
    const platos = plato1.data;
    console.log(platos);
    if (button7.style.backgroundColor === "green") {
      Swal.fire({
        title: "Registrar Venta",
        showCancelButton: false,
        showConfirmButton: false,
...
async function presiono8() {
  try {
    ...
    const platos = plato1.data;
    console.log(platos);
    if (button8.style.backgroundColor === "green") {
      Swal.fire({
        title: "Registrar Venta",
        showCancelButton: false,
        showConfirmButton: false,
...
async function presiono9() {
  try {
    ...
    const platos = plato1.data;
    console.log(platos);
    if (button9.style.backgroundColor === "green") {
      Swal.fire({
        title: "Registrar Venta",
        showCancelButton: false,
        showConfirmButton: false,
